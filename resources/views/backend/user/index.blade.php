        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 col-md-12 col-lg-12 d-flex justify-content-end">
                    <a href="{{route('user.create')}}" class="btn btn-success"> <i class="fa fa-plus"> New New </i> </a>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-12">
                    <table class="table table-bordered table-active dataTable">
                        ...
                        <tr>
                            <th>{{$key+1}}</th>
                            <td>@if($user->status == '1') <a class=" bg-success text-white p-1">Active</a> @else <a
                                    class="bg-danger text-white p-1">Inactive</a>  @endif</td>
                            <td>{{$user->name}}</td>
                            <td>{{$user->email}}</td>
                            <td>
                                @if($user->image == true)
