...
{{--                                <div class="input-number__sub"></div>--}}
                                ...
                                <form action="{{ route('cart.update') }}" method="POST">
                                   ...
                                   <div class="d-flex">
                                       ...
                                       <button type="submit" class="btn btn-primary cart__update-button">update</button>
                                   </div>
                                </form>
...
{{--                            </button>--}}
                    ...
                    @endforeach
                    @else
                        <h3> Please add some product in your cart</h3>
                    @endif
                    </tbody>
                </table>
                <div class="cart__actions">
                    ...
                    <div class="cart__buttons"><a href="{{route('continue.shopping')}}" class="btn btn-primary cart__update-button">Continue Shopping</a>
                    ...
                    <div class="col-12 col-md-7 col-lg-6 col-xl-5">
                        <div class="card">
                            <div class="card-body"><h3 class="card-title">Cart Totals</h3>
                                ...
                                @else
                                    <p> Please add some product in your cart</p>
                                @endif
                                <a class="btn btn-primary btn-xl btn-block cart__checkout-button" href="{{route('order.checkout')}}">Proceed
                                    to checkout</a></div>
                        </div>
                    </div>
                </div>
