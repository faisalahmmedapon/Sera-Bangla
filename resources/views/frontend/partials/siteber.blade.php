            ...
            <ul class="departments__links">
                <li class="departments__item"><a href="#">Power Tools
                    ...
                    <div class="departments__megamenu departments__megamenu--xl">
                        ...
                        <div class="megamenu megamenu--departments"
                             style="background-image: url('{{asset('frontend')}}/images/megamenu/megamenu-1.jpg');">
                            <div class="row">
                                <div class="col-3">
                ...
                <li class="departments__item"><a href="#">Hand Tools
                    ...
                    <div class="departments__megamenu departments__megamenu--lg">
                        <!-- .megamenu -->
                        <div class="megamenu megamenu--departments"
                             style="background-image: url('{{asset('frontend')}}/images/megamenu/megamenu-2.jpg');">
                            <div class="row">
                                <div class="col-4">
                                    <ul class="megamenu__links megamenu__links--level--0">
                                        <li class="megamenu__item megamenu__item--with-submenu">
                ...
                <li class="departments__item"><a href="#">Machine Tools
                    ...
                    <div class="departments__megamenu departments__megamenu--nl">
                        <!-- .megamenu -->
                        <div class="megamenu megamenu--departments"
                             style="background-image: url('{{asset('frontend')}}/images/megamenu/megamenu-3.jpg');">
                            <div class="row">
                                <div class="col-6">
                                    <ul class="megamenu__links megamenu__links--level--0">
                                        <li class="megamenu__item megamenu__item--with-submenu">
